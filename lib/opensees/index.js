...
OpenSees.prototype.init = function() {
  if ( !tcpInitialized ) {
    console.log( "dataport is ", exports.dataPort );
...
module.exports = exports = OpenSees;
...
// var tcpInitialized = false;
// exports.initInternalDataPort = function( port ) {
//   if ( !tcpInitialized ) {
...
//       }
//     });
//     console.log( 'using ' + port + ' for internal communication');
